  ...
  const categories = [
    {
      icon: <FaCode />,
      title: "Frontend",
      description: "HTML, CSS, JavaScript, React.js, Vue.js, Tailwind CSS",
    },
    {
      icon: <FaServer />,
      title: "Backend",
      description: "PHP, Laravel, MySQL, REST APIs",
    },
    {
      icon: <FaTools />,
      title: "Tools",
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-[18px]">
          {skills.map((skill, index) => (
            <motion.div
              ...
              className="bg-slate-900 border border-slate-800 rounded-[16px] p-[20px] flex flex-col items-center justify-center cursor-pointer hover:border-cyan-400 hover:shadow-[0_0_25px_rgba(34,211,238,0.25)] transition-all"
            >
              <img
                src={skill.image}
                alt={skill.name}
        ...
        <div className="grid md:grid-cols-3 gap-[18px] mt-[45px]">
          {categories.map((item, index) => (
            <motion.div
              ...
              whileHover={{ y: -8 }}
              className="bg-slate-900 border border-slate-800 rounded-[16px] p-[22px] text-center hover:border-cyan-400 hover:shadow-[0_0_25px_rgba(34,211,238,0.15)] transition-all"
            >
