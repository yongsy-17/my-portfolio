    ...
    <footer className="bg-slate-950 border-t border-slate-800">
      <div className=" px-[120px] py-[50px]">
        <div className="grid md:grid-cols-3 gap-[40px]">
          <div>
            <h2 className="text-[24px] font-bold text-white">
              Yongsy<span className="text-cyan-400">.</span>
              <span className="text-cyan-400">Din</span>
            </h2>

            <p className="text-gray-400 text-[14px] leading-7 mt-[15px]">
              Passionate Web Developer dedicated to building modern,
            ...
            <div className="flex gap-[12px] mt-[20px]">
              {socialLinks.map((item) => (
                <a
                  ...
                  className="w-[40px] h-[40px] rounded-full bg-slate-900 border border-slate-700 flex items-center justify-center text-white hover:bg-cyan-400 hover:text-slate-950 hover:border-cyan-400 transition duration-300"
                >
                  {item.icon}
                </a>
              ))}
        ...
        <div className="border-t border-slate-800 mt-[40px] pt-[20px] flex flex-col md:flex-row items-center justify-between">
          ...
          <a
            href="#home"
            className="flex items-center gap-[8px] text-cyan-400 text-[14px] mt-[15px] md:mt-0 hover:text-cyan-300 transition"
          >
            Back to Top
            <FaArrowUp />
          </a>
