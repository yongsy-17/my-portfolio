  ...
  const projects = [
    {
      ...
      View_Project:
        "https://github.com/sonarykheang123/Music-Player-App-G6",
    },
    {
      id: "02",
      ...
      View_Project:
        "https://github.com/OEUBROCHOM/VC1-G9-Daily-Needs",
    },
    {
      id: "03",
      ...
      View_Project:
        "https://github.com/radytrainer/air-quality-dashboard",
    },
  ];

  return (
    <section id="projects" className="scroll-mt-[80px] bg-slate-950 py-[60px]">
      <div className=" px-[120px]">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-[18px]">
          {projects.map((project) => (
            <div
              key={project.id}
              className="bg-slate-900 border border-slate-800 rounded-[14px] overflow-hidden group hover:border-cyan-400 transition duration-300 flex flex-col"
            >
              <div className="overflow-hidden">
                <img
                  src={project.image}
                  alt={project.title}
                  className="w-full h-[170px] object-cover group-hover:scale-105 duration-500"
                />
              </div>
              ...
              <div className="p-[16px] flex flex-col flex-1">
                ...
                <div className="flex flex-wrap gap-[6px] mt-[14px]">
                  {project.tags.map((tag) => (
                    <span
                      key={tag}
                      className="px-[10px] py-[4px] rounded-full bg-slate-800 text-gray-300 text-[11px]"
                    >
                      {tag}
                    </span>
                  ))}
                ...
                <div className="mt-auto pt-[20px] flex justify-end">
                  <a
                    ...
                    className="inline-flex items-center gap-[6px] text-cyan-400 text-[14px] font-semibold hover:text-cyan-300 transition"
                  >
                    View Project
